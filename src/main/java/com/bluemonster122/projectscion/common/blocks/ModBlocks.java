...
import com.bluemonster122.projectscion.common.blocks.farms.BlockCobbleGenerator;
...
import com.bluemonster122.projectscion.common.blocks.farms.BlockUnobtainableMatter;
...
public enum ModBlocks {
    ...
    COBBLE_GENERATOR(BlockCobbleGenerator.class),
    AREA_DEFINITION(BlockAreaDefinition.class),
    UNOBTAINABLE_MATTER_BLOCK(BlockUnobtainableMatter.class),
    COMPRESSED_OBSIDIAN(BlockObsidianCompressed.class),;
