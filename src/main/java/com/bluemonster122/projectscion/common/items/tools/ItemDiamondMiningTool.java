...
public class ItemDiamondMiningTool extends ItemBase implements IProvideRecipe {
    ...
    public void RegisterRecipes() {
        ...
        GameRegistry.addShapedRecipe(Items.DIAMOND_MINING_TOOL.getStack(1), "DD", "ID", 'D', net.minecraft.init.Items.diamond, 'I', Items.IRON_MINING_TOOL.getStack(1, -1));
    }
}
