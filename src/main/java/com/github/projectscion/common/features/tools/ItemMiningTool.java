...
public class ItemMiningTool extends Item implements IProvideEvent {
    ...
    public ItemMiningTool(String name) {
        super();
        setCreativeTab(CreativeTabs.TOOLS);
        setRegistryName(new ResourceLocation(ModInfo.MOD_ID, "mining_tool_" + name));
        setUnlocalizedName(getRegistryName().toString());
        setMaxStackSize(1);
        setMaxDamage(name == "iron" ? 512 : 2048);
    }
    ...
    public void addInformation(ItemStack stack, EntityPlayer playerIn, List<String> tooltip, boolean advanced) {
        tooltip.clear();
        tooltip.add(getUnlocalizedName(stack));
        tooltip.add("Durability = " + stack.getTagCompound().getInteger("ToolDurability"));
    }
}
