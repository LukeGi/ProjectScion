...
public class RegistrationHelper {
	...
	// itemBlock =
	// itemBlockClass.getConstructor(Block.class).newInstance(block);
	//
	// internalName = ((BlockBase) block).getInternalName();
	//
	// if (!internalName.equals(internalName.toLowerCase(Locale.US)))
	// throw new IllegalArgumentException(
	// String.format("Unlocalized names need to be all lowercase! Item: %s",
	// internalName));
	//
	// if (internalName.isEmpty())
	// throw new IllegalArgumentException(
	// String.format("Unlocalized name cannot be blank! Item: %s",
	...
	// }
	//
	// LogHelper.info(String.format("Registered block (%s)",
	// blockClass.getCanonicalName()));
	// } catch (Exception ex) {
	// LogHelper.fatal(String.format("Fatal Error while registering block (%s)",
	// blockClass.getCanonicalName()));
	// ex.printStackTrace();
	// }
	//
	...
	// }
	//
	// LogHelper.info(String.format("Registered item (%s)",
	// itemClass.getCanonicalName()));
	// } catch (Exception ex) {
	// LogHelper.fatal(String.format("Fatal Error while registering item (%s)",
	// itemClass.getCanonicalName()));
	// ex.printStackTrace();
	// }
	//
